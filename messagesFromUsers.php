...
if( isset($_GET['messagesFromUsers']) )
{
    $NotificationID = $_GET['messagesFromUsers'];
...
function submitChat() {
	...
	xmlhttp.open('GET','Controller/sendMessages.php?msg='+msg+'&id='+id,true);
	xmlhttp.send();
...
<body>
	<div class="header">
		...
		<h1>您現在跟<?php echo $row['ClientName']?>對話</h1>
	</div>
...
正在載入對話...
		...
		<br/>
		<textarea name="msg" placeholder="輸入訊息" cols=30  rows=5></textarea> 
		<br/>
		<a href="#" onclick="submitChat()">發送訊息</a><br /><br />      
		<a href="usersMessageList.php">回到發送邀請頁</a><br /><br />         
        </div>  
